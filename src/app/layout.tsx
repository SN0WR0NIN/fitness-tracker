...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return <html lang="en" suppressHydrationWarning className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}><body className="min-h-full flex flex-col"><Providers><DefaultCollapsedProfileTabs/><ChallengeCompletionRedirect/>{children}</Providers></body></html>;
}
