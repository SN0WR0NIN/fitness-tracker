...
export default function AdminCreateActivityForm({ users, friendUsers = users, scoringRules, challengeStart, challengeEnd, today }: {
  users: UserOption[];
  friendUsers?: Array<{ id: string; name: string }>;
