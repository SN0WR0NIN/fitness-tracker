...
export default async function ParticipantProfilePage({params}:{params:Promise<{id:string}>}){
  ...
  return <div className="min-h-screen bg-slate-950 text-white"><Navbar/><main className="page-enter mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
    ...
    <section className="motion-card relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-5 sm:p-8">
...
function HeroStat({label,value,detail}:{label:string;value:string;detail:string}){return <div className="motion-card interactive-lift rounded-2xl border border-white/10 bg-slate-950/40 p-4"><p className="text-xs text-slate-400">{label}</p><p className="mt-2 text-2xl font-black">{value}</p><p className="mt-1 text-xs text-slate-500">{detail}</p></div>;}
function Snapshot({label,value,detail}:{label:string;value:string;detail:string}){return <div className="motion-card interactive-lift rounded-2xl border border-white/10 bg-white/[0.04] p-4"><p className="text-[0.68rem] font-black uppercase tracking-wider text-slate-500">{label}</p><p className="mt-2 text-xl font-black sm:text-2xl">{value}</p><p className="mt-1 text-xs text-slate-500">{detail}</p></div>;}
