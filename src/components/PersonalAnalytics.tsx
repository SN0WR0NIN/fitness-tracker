...
export default function PersonalAnalytics({activities,today}:{activities:MetricActivity[];today:string}) {
  ...
  return <div className="space-y-6">
    <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
      <section className={panel}><h2 className="text-lg font-black">Points — last 7 days</h2><p role="status" className="mt-2 text-sm text-lime-300">{dateLabel(data.days[day].date)} · {data.days[day].points.toFixed(1)} points</p>
