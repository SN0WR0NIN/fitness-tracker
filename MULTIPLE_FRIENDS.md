...
An activity earns the configured friend bonus once, never once per friend. No additional activity, points or alert is created for a selected friend. Social achievements still count approved activities, not people.
