      ...
      <main>
        ...
        <div className="mx-auto max-w-5xl space-y-10 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          <section>
            ...
            <p className="mt-4 rounded-xl border border-lime-300/20 bg-lime-300/[0.06] px-4 py-3 text-sm text-slate-300"><strong className="text-lime-300">Rounding rule:</strong> after eligible bonuses are added, the saved score always rounds down to the lower 0.5-point increment. For example, 7.99 becomes 7.5 while 7.5 stays 7.5.</p>
          </section>
